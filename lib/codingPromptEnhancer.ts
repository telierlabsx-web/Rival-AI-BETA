...
export const getEnhancedCodingPrompt = (
  ...
  if (detectedFramework && FRAMEWORK_GUIDELINES[detectedFramework as keyof typeof FRAMEWORK_GUIDELINES]) {
    enhancedPrompt += '\n\n' + FRAMEWORK_GUIDELINES[detectedFramework as keyof typeof FRAMEWORK_GUIDELINES];
  }
