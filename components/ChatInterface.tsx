...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({ 
  ...
  // 🔥 TAMBAH isAutoMode & setIsAutoMode dari hook
  const {
    isLoading,
    activeMode,
    setActiveMode,
  ...
  return (
    <div className="flex-1 flex flex-col h-full relative">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto no-scrollbar pt-2 pb-[280px]">
      ...
      {/* 🔥 PASS isAutoMode & setIsAutoMode ke ChatInput */}
      <ChatInput 
        input={input}
        setInput={setInput}
        isLoading={isLoading}
