...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({ 
  ...
  // 🔥 FIX: Auto scroll dengan smooth behavior
  useEffect(() => {
  ...
  return (
    // 🔥 FIX: h-screen untuk desktop, h-[100dvh] untuk mobile
    <div className="flex-1 flex flex-col h-screen md:h-[100dvh] relative overflow-hidden">
      ...
      {/* 🔥 FIX: pb-56 untuk kasih ruang input box + spacer */}
      <div ref={scrollRef} className="flex-1 overflow-y-auto no-scrollbar pt-2 pb-56">
        {session.messages.length === 0 ? (
          ...
          <div className="flex flex-col">
            ...
            {/* 🔥 FIX: Spacer lebih tinggi biar scroll works */}
