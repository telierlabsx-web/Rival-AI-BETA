...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({ 
  ...
  return (
    // FIX: Menggunakan h-[100dvh] agar tinggi pas di layar mobile (menghindari tertutup browser bar)
    <div className="flex-1 flex flex-col h-[100dvh] relative">
      ...
      {/* FIX: Padding bottom (pb-32) + Spacer Div di bawah untuk memastikan konten bisa discroll naik */}
      <div ref={scrollRef} className="flex-1 overflow-y-auto no-scrollbar pt-2 pb-10">
        {session.messages.length === 0 ? (
          ...
          <div className="flex flex-col">
                ...
                <div className="w-full max-w-4xl flex gap-6 md:gap-10 px-6">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="relative w-8 h-8 flex-shrink-0">
                      ...
                      <div className={`absolute inset-[6px] rounded-full border-[3px] border-transparent ${
                        profile.isOfflineMode 
            ...
            {/* FIX: SPACER KHUSUS. Ini akan memaksa scroll area bertambah tinggi di bagian bawah */}
