...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({ 
  ...
  // 🔥 HANDLE SCROLL - Detect user scroll
  const handleScroll = () => {
  ...
  // 🔥 AUTO-SCROLL saat AI typing (hanya kalau user ga scroll up)
  useEffect(() => {
  ...
  }, [session?.messages, isLoading, userHasScrolled]);
  ...
  const handleSend = () => {
    ...
    setUserHasScrolled(false); // Reset scroll state saat kirim message
  };
      ...
      >
        ...
        {showScrollButton && (
          <button
            ...
            className={`fixed bottom-72 right-6 z-50 w-10 h-10 md:w-11 md:h-11 rounded-full shadow-2xl flex items-center justify-center transition-all ${
              isDark 
