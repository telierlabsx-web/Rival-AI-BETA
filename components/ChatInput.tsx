...
// Icon-icon SVG Monokrom (Grok Style)
const Icons = {
...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    // Gunakan sticky agar tidak menutupi riwayat chat dan responsif terhadap keyboard
    <div className="sticky bottom-0 w-full z-[100] bg-transparent pb-[env(safe-area-inset-bottom)]">
      <div className="max-w-3xl mx-auto px-4 pb-4">
        
        {/* POPUP ATTACHMENT - SVG Only (Foto 75858.jpg) */}
        {isAttachOpen && (
          <div className="absolute bottom-[75px] left-4 w-44 animate-in fade-in slide-in-from-bottom-2 duration-150">
        ...
        {/* POPUP MODE - Sejajar di Kiri (Foto 75859.jpg) */}
        {isModeOpen && (
          <div className="absolute bottom-[75px] left-4 w-[310px] animate-in fade-in slide-in-from-bottom-2 duration-150">
              ...
              <div className="px-5 py-4 border-b border-white/5 flex items-center justify-between">
                <div className="flex flex-col">
                  <div className="flex items-center gap-2">
                    <span className="text-white"><Icons.Auto /></span>
        ...
        {/* INPUT BAR - Layout Foto 76360.jpg */}
        <div className={`${isDark ? 'bg-[#121212] border-white/10' : 'bg-white border-black/10'} rounded-[28px] border shadow-xl`}>
          <div className="flex flex-col p-2">
            <textarea
              ...
              className={`w-full bg-transparent px-4 py-2 focus:outline-none text-[16px] ${isDark ? 'text-white' : 'text-black'} placeholder-zinc-500 resize-none`}
              rows={1}
            />
            
            <div className="flex items-center justify-between px-2 pb-1 mt-1">
              <div className="flex items-center gap-1.5">
                <button onClick={() => {setIsAttachOpen(!isAttachOpen); setIsModeOpen(false);}} className="p-2 text-zinc-500 hover:text-white transition-colors">
