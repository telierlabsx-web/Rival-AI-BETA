      ...
      <div className="max-w-3xl mx-auto w-full pointer-events-auto space-y-2">
        ...
        <div className={`relative ${colors.bg} rounded-[30px] border ${colors.border} shadow-xl`}>
          ...
          <div className="px-2.5 py-2 flex items-center gap-2">
            {/* MIC BUTTON */}
            <button onClick={() => setIsAttachmentOpen(!isAttachmentOpen)} className={`p-2.5 rounded-full ${isAttachmentOpen ? colors.activeBg : colors.micBg} transition-all flex-shrink-0`}>
            ...
            <input
              ...
              className={`flex-1 bg-transparent focus:outline-none text-[15px] ${colors.text} placeholder:${colors.textMuted}`}
            />
