...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  // 🔥 Cek apakah auto mode aktif langsung dari activeMode
          ...
          <div className="flex flex-col p-2">
            ...
            <div className="flex items-center justify-between px-2 pb-1 mt-1">
              <div className="flex items-center gap-1.5">
                ...
                {/* 🔥 MODE SELECTOR BUTTON - cek langsung activeMode */}
                <button 
                ...
                >
                  ...
                  {/* 🔥 AUTO MODE INDICATOR - tampil hanya kalau auto aktif */}
                  {isAutoActive && (
