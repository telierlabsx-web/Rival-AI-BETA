               ...
               {profile.offlineModelDownloaded ? (
                 <div className="space-y-4 pt-4">
                    ...
                    <button 
                      ...
                      className="w-full py-4 text-[10px] font-black uppercase tracking-widest opacity-20 hover:text-red-500 hover:opacity-100 transition-all"
                    >
          ...
          <div className="space-y-12 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-10">
              <div className="flex flex-col gap-6">
                <img src={profile.avatar} className="w-32 h-32 rounded-[2.5rem] object-cover border border-current/10 shadow-2xl" alt="User" />
                <button className="text-[10px] font-black uppercase tracking-widest opacity-40 hover:opacity-100 transition-all text-left">Ganti Foto Profil</button>
              </div>
              <div className="space-y-8">
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-[0.3em] opacity-30">Nama Tampilan</label>
                  <input type="text" value={profile.name} onChange={(e) => onUpdateProfile({ ...profile, name: e.target.value })} className="w-full bg-current/[0.03] border-b border-current/10 py-4 px-6 rounded-2xl focus:outline-none text-base font-black" />
                </div>
              </div>
            </div>
          </div>
