...
export const MessageRow: React.FC<MessageRowProps> = ({
  ...
  // Anti "Page List" Fallback
  // Jika karena suatu alasan asisten mengirim teks mentah yang terlihat seperti struktur ebook, 
  // kita coba bersihkan supaya user nggak liat sampah teks.
